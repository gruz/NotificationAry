...
?>
	...
	<input type="text" id="<?php echo $id; ?>_id" name="<?php echo $name; ?>" value="<?php echo $value; ?>" data-onchange="<?php echo $this->escape($onchange); ?>"/>
<?php /*
	<?php if (!$readonly) : ?>
		<a class="btn btn-success modal_<?php echo $id; ?>" title="<?php echo JText::_('JLIB_FORM_CHANGE_USER'); ?>" href="<?php echo $link; ?>" rel="{handler: 'iframe', size: {x: 800, y: 500}}">
